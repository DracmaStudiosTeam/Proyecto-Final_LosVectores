...
{
	int opc; // Determina la opcion seleccionada
	...
	do
	{
		opc = solUsuario(); // Se almacena la opcion seleccionada
		opcEsc(opc, nomUsuario, usuario, nomContra, contra, &cont1); // Se evalua que opcion se escogio
